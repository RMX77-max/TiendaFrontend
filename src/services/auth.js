...
const URL_BASE_API = process.env.API_BASE_URL || 'http://localhost/Tiendabackend/public/api'
...
async function solicitar (ruta, opciones = {}) {
  ...
  const cabeceras = {
    ...
    ...(opciones.body && !esFormulario ? { 'Content-Type': 'application/json' } : {}),
    ...(opciones.headers || {})
  }
  ...
  if (!respuesta.ok) {
    ...
    const error = new Error(primerErrorValidacion || datos.message || 'Ocurrio un error al procesar la solicitud.')
