<template>
  <div class="pagina-acceso q-pa-md">
    <div class="pagina-acceso__fondo" />

    <div class="acceso-layout">
      <div class="panel-acceso-completo shadow-10">
        <section class="panel-acceso-visual">
          <img
            class="panel-acceso-visual__imagen"
            src="/imagenes/imagen1.jpg"
            alt="Equipos de computacion"
          />
        </section>

        <section class="panel-acceso-formulario">
          <div class="text-caption text-weight-bold texto-resalte-acceso">
            Acceso interno
          </div>
          <div class="text-h4 text-weight-bold q-mt-sm">Iniciar sesion</div>
          <p class="text-body2 text-grey-7 q-mt-sm q-mb-xl">
            Ingresa con tu usuario del sistema para acceder al panel interno de
            la tienda.
          </p>
          ...
          >
            Usuario de prueba: <strong>gerente</strong> | Contrasena:
